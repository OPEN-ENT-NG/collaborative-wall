...
import net.atos.entng.collaborativewall.events.CollaborativeWallMessageWrapper;
...
public interface CollaborativeWallRTService {
   ...
   * @param user the user who is connecting to the wall
   ...
   */
  Future<List<CollaborativeWallMessage>> onNewConnection(final String wallId, final UserInfos user, final String wsId);
  ...
  Future<List<CollaborativeWallMessage>> onNewUserAction(CollaborativeWallUserAction action, String wallId, String wsId, UserInfos user, final boolean checkConcurency);
   ...
   */
  void subscribeToNewMessagesToSend(final Handler<CollaborativeWallMessageWrapper> subscriber);
  ...
  Future<List<CollaborativeWallMessage>> pushEventToAllUsers(final String wallId,final UserInfos session, final CollaborativeWallUserAction action, final boolean checkConcurency);

  Future<List<CollaborativeWallMessage>> pushEvent(final String wallId,final UserInfos session, final CollaborativeWallUserAction action, final String wsId, final boolean checkConcurency);
