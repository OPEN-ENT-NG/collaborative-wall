    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var wallBehaviours = {
        ...
        workflow: {
          ...
          printnotes:
            "net.atos.entng.collaborativewall.controllers.CollaborativeWallController|printnotes",
        },
      };
      /**
       * Register behaviours.
       */
      entcore_1.Behaviours.register("collaborativewall", {
        ...
        workflow: function () {
          ...
          for (var prop in wallWorkflow) {
            if (entcore_1.model.me.hasWorkflow(wallWorkflow[prop])) {
              workflow[prop] = true;
            }
          }
          return workflow;
        ...
        loadResources: function (callback) {
          axios_1.default.get("/collaborativewall/list/all").then(
            function (walls) {
              this.resources = entcore_1._.map(walls.data, function (wall) {
                return {
                  title: wall.name,
                  ...
                  icon: wall.icon
                    ? wall.icon
                    : "/img/illustrations/collaborative-wall.svg",
                  path: "/collaborativewall/id/" + wall._id,
                  id: wall._id,
                };
              });
