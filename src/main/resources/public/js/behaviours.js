	...
	entcore_1.Behaviours.register('collaborativewall', {
	    ...
	    resource: function (resource) {
	        ...
	        for (var behaviour in wallBehaviours.resources) {
	            if (entcore_1.model.me.hasRight(rightsContainer, wallBehaviours.resources[behaviour]) || entcore_1.model.me.userId === resource.owner.userId || entcore_1.model.me.userId === rightsContainer.owner.userId) {
	    ...
	    loadResources: function (callback) {
	        axios_1.default.get('/collaborativewall/list/all').then(function (walls) {
